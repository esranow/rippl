"""rippl.core.simulation — Simulation.run() via existing FD solvers."""
from __future__ import annotations
import torch
from typing import Optional
from rippl.core.system import System
from rippl.core.solver_registry import select_solver
from rippl.physics.operators import Diffusion, Advection
...
class Simulation:
    ...
    def run(
        ...
        dx = spacings[0]
        from rippl.core.solver_registry import get_solver
...
def run_system(system: System, mode: str = "sim", **kwargs):
    """
    High-level entry point for Rippl.
