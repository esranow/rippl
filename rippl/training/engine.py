...
from rippl.models import build_model  # triggers all @register_model decorators
from rippl.physics.pde import PDESpec
from rippl.physics.residuals import build_residual_fn
from rippl.physics.boundary import DirichletBC, NeumannBC, PeriodicBC
from rippl.training.callbacks import Callback, CheckpointCallback
from rippl.physics_blocks import BLOCK_REGISTRY
